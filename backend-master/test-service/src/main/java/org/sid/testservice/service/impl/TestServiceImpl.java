...
public class TestServiceImpl implements TestService {
    ...
    @Override
    public long countTestCasesByUserAndPeriod(String userId, Date startDate, Date endDate) {
        return testRepository.countByouvertAndDeadlineBetween(userId, startDate, endDate);
    }
    @Override
    ...
    public List<Map<String, Object>> getAllUsersTestCaseCounts() {
        return testRepository.countTestCasesByUser();
    }
    @Override
    ...
    public TestDto updateTest(Long id, TestDto updatedTest, JiraDto updatedJira) {
        ...
        test.setOuvert(updatedTest.getOuvert());
    ...
    private boolean checkCondition(Test test) {
        return test != null && "OK".equalsIgnoreCase(test.getTest_statut());
    }
