...
import org.sid.testservice.sec.KeycloakService;
...
public class TestControlller {
    ...
    @Autowired
    public TestControlller(KeycloakService keycloakService, TestService testService, JiraServiceClient jiraServiceClient) {
    ...
    public List<Map<String, Object>> getAllUsersTestCaseCounts() {
        return testService.getAllUsersTestCaseCounts();
    }
    @GetMapping("/user/{userId}/count")
    public ResponseEntity<Long> countTestCasesByUserAndPeriod(
            @PathVariable String userId,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date startDate,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date endDate) {
        long count = testService.countTestCasesByUserAndPeriod(userId, startDate, endDate);
